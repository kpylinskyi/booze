...
public:
     ...
     */
    std::future<bool> isPackageInstalled(const std::string &package_name);
     ...
     */
    std::future<bool> installPackage(const std::string &package_name);
     ...
     */
    std::future<bool> upgradePackage(const std::string &package_name);
     ...
     */
    std::future<bool> uninstallPackage(const std::string &package_name);
     ...
     */
    std::future<std::vector<Package>> searchPackages(const std::string &query);

    /**
     * @brief Lists all installed packages.
     * @return A vector of Package objects representing all installed packages.
     */
    std::future<std::vector<Package>> listInstalledPackages();
     ...
     */
    std::future<Package> getPackageInfo(const std::string &package_name);
